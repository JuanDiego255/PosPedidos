    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.status == 1) {
                ...
                html = ' <a class=" text-danger" href="javascript:void(0)"  onclick="RemoveCopon()">Eliminar</a> ';



                html1 = '<li class="list-group-item" id="discount_1">Descuento (-) <span>'+ currency_formate(response.data.price)+'</span></li>';
                ...
                $('#promocode_code').html(response.data.code + " Aplicado");
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.status == 1) {
                ...
                // updated code by Hadi for COD or the two new methods: begins
                    //if (payment_type == "cod") { // OLD CODE
                    if (payment_type == 11 || payment_type == 29 || payment_type == 30) { // NEW CODE
                // updated code by Hadi for adding two new payment methods: ends
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            // Code added by hadi for two new payment methods:begins
                            payment_id: payment_type,
                            // Code added by hadi for two new payment methods:ends

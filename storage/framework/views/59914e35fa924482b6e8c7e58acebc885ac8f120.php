        ...
        <div class=" <?php echo e(session()->get('direction') == 2 ? 'wrapper_rtl' : 'wrapper'); ?>  wp_chat_box d-none">
            ...
            <div class="chat-form">
                <form action="https://api.whatsapp.com/send" method="get" target="_blank"
                    ...
                    <textarea class="form-control" name="text" placeholder="Escribe tu mensaje" required></textarea>
...
<?php /**PATH C:\laragon\www\restropro\resources\views/front/theme/default.blade.php ENDPATH**/ ?>
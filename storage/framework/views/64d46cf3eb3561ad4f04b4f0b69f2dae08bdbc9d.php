            ...
            <div class="row border-top gx-2">
                ...
                <div class="col-md-12 col-lg-4 px-0">
                    <div class="card my-4 border p-3 rounded-4 shadow">
                        <p class="title pb-2"><?php echo e(trans('labels.order_summary')); ?></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u244677816/domains/stocky.uno/public_html/ecostore/resources/views/front/cart.blade.php ENDPATH**/ ?>
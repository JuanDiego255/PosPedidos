...
<div class="offcanvas offcanvas-end pos_sidebar" tabindex="-1" id="rightsidebar" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasRightLabel">Información al cliente</h5>
                ...
                <div class="card border-0 rounded-4 right-sidemain">
                    <div class="card-body px-0 desktop-card-body pt-0">
                        ...
                        <div class="border-bottom pb-3 px-2">
                            <div class="row">Reiniciar venta
                                <div class="col-lg-12">
                                    <select class="form-select" aria-label="Defapreloaderult select example" id="customer1">
                                ...
                                <div class="col-lg-4">
                                    <!-- <button class="btn btn-danger" onclick="RemoveCart('')">Reiniciar venta</button> -->
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="pro-itmes p-3 pb-0">
                            ...
                            <div class="card mb-3 border rounded-4 shadow-sm posproductimg">
                                <div class="card-body d-flex align-items-center p-0">
                                    <img src="<?php echo e(asset(env('ASSETSPATHURL').'item/' . $cart->item_image)); ?>" alt="">
                                    <div class="px-2">
                        ...
                        <div class="payment-option text-capitalize px-3">
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-3">
                                ...
                                <?php if(count($cartitems) > 0): ?>
                                <button class="btn btn-danger py-3 w-100 rounded-5" onclick="RemoveCart('')">Reiniciar venta</button>
                                <?php endif; ?>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Factura POS</h1>
            ...
            <div class="modal-body">
               ...
               <h6 class="fw-semibold text-center mt-4">
    <?php echo e(trans('labels.thank_you_note')); ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                            ...
                            <label class="bg-light">
                                ...
                                <div class="card h-100 rounded-3">
                                    <div class="card-body p-2 w-100 d-flex justify-content-center">
                                        <div>
                                            <img src="<?php echo e(url(env('ASSETSPATHURL').'images/llevar.png')); ?>" alt="" class="">
                                        </div>
                                    </div>
                                </div>
                            </label>
                        ...
                        <div class="w-100 rounded-4">
                            <label class="bg-light">
                                ...
                                <div class="card h-100 rounded-3">
                                    <div class="card-body p-2 w-100 d-flex justify-content-center">
                                        <div>
                                            <img src="<?php echo e(url(env('ASSETSPATHURL').'images/entrega.png')); ?>" alt="">
                                        </div>
                                    </div>
                                </div>
                            </label>
                ...
                <hr>
                <div class="payment-option text-capitalize px-3">
                    <h1 class="modal-title fs-5 fw-600">Opcion De Pago</h1>
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-3">
                        <div class="w-100 rounded-4">
                            <label class="bg-light">
            ...
            <div class="modal-footer">
                <div class="gap-1 d-flex justify-content-md-end sm-w-100">
                    <a href="http://192.168.29.206/restro/admin/plan" class="btn btn-danger btn-cancel m-1 sm-w-100" data-bs-dismiss="modal">Cerar</a>
                    <a href="#" class="btn btn-success btn-succes m-1 sm-w-100" <?php if(count($cartitems)> 0): ?> onclick="placeorder()" <?php endif; ?> >Enviar</a>
                </div>
            </div>
        </div>
    </div>
...
<script src="<?php echo e(url(env('ASSETSPATHURL') . 'admin-assets/js/pos_cartview.js')); ?>" type="text/javascript"></script><?php /**PATH /home/u244677816/domains/stocky.uno/public_html/ecostore/resources/views/admin/pos/cartview.blade.php ENDPATH**/ ?>
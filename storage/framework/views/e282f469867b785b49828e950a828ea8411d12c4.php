                ...
                <div class="col-md-12 col-lg-6 order-2 order-lg-0 successfully-contain">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-md-4  btn-container">
                              ...
                              <a  href="https://api.whatsapp.com/send?phone=<?php echo e(helper::appdata($storeinfo->id)->contact); ?>&text=<?php echo e($whmessage); ?>" class=" " target="_blank">
...
<?php /**PATH /home/lotquispe/mailpro.rimberio.site/resources/views/front/ordersuccess.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label"><?php echo e(trans('labels.personlized_link')); ?></label>
                                                <div class="input-group mb-2">
                                                    <span class="input-group-text rounded-start-3"><?php echo e(URL::to('/')); ?></span>
                                                    <input type="text" class="form-control mb-0" id="slug" name="slug" value="<?php echo e(Auth::user()->slug); ?>">
                                                </div>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="card border-0 box-shadow">
                            ...
                            <div class="card-body">
                                <form method="POST" action="<?php echo e(URL::to('admin/settings/update-profile-' . Auth::user()->id)); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                                        <div class="form-group col-sm-6">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u244677816/domains/stocky.uno/public_html/v2ecostore/resources/views/admin/otherpages/settings.blade.php ENDPATH**/ ?>
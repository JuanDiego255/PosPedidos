    ...
    <div id="printDiv" class="pos-modal">
        ...
        <?php $i=0; ?>
            ...
            <div class="items-details border-bottom mt-2">
                ...
                <div class="items border-0 mb-2">
                    <p class="fw-normal"><?php echo e(trans('labels.tax')); ?></p>
                    <p class="fw-normal"><?php echo e(@helper::currency_formate($item->tax, Auth::user()->id)); ?></p>
                </div>
                <div class="items border-0 mb-2">
...
</body><?php /**PATH /home/u244677816/domains/stocky.uno/public_html/ecostore/resources/views/admin/orders/print.blade.php ENDPATH**/ ?>
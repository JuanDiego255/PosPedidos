    ...
    <div class="col-md-12 col-lg-12 col-xl-6 <?php echo e($transaction_type == 'cod' && Auth::user()->type == 1 ? 'd-none' : ''); ?> <?php echo e($transaction_type == 'banktransfer' && Auth::user()->type == 2 ? 'd-none' : ''); ?>">
        <form action="<?php echo e(URL::to('admin/payment/update')); ?>" method="POST" class="" enctype="multipart/form-data">
            ...
            <div class="card h-100">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <?php if($pmdata->editable == 1): ?>
                                        <div class="form-group">
                                            <input type="text" required="" id="payment_method" class="form-control" name="payment_method_name" placeholder="<?php echo e(trans('labels.payment_method')); ?>" value="<?php echo e($pmdata->payment_name); ?>">
                                        </div>
                                    <?php else: ?>
                                        <b>
                ...
                <div class="card-body">
                    <div class="row">
                        <?php if(!in_array($pmdata->id,[11,29,30])): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u244677816/domains/stocky.uno/public_html/ecostore/resources/views/admin/payment/payment.blade.php ENDPATH**/ ?>
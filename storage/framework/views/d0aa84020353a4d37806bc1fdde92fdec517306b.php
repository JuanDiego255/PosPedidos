        ...
        <div class="row contact-form">
            <div class="col-lg-12 col-sm-12 col-auto mb-4 mb-lg-0">
                <div class="card shadow rounded-5 h-100 select-delivery py-3 px-2">
                    <div class="card-body">
                        <form action="<?php echo e(URL::To('/book')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
...
<?php echo $__env->make('front.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u244677816/domains/stocky.uno/public_html/ecostore/resources/views/front/tablebook.blade.php ENDPATH**/ ?>
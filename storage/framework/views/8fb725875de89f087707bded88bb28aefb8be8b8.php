        ...
        <div class="row contact-form">
            <div class="col-12 col-lg-8 col-sm-12 col-auto mb-4 mb-lg-0">
                <div class="card shadow rounded-5 h-100 select-delivery py-3 px-2">
                    <div class="card-body">
                        <form action="<?php echo e(URL::To('/submit')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
                            ...
                            <li>
                                ...
                                <span class="px-2">
                                    ...
                                    <a href="#"> 
                                        ...
                                        <?php else: ?>
                                            (<?php echo e($timing->open_time); ?> a <?php echo e($timing->close_time); ?>)  
                                        <?php endif; ?>
                                    </a>    
...
<!-- contact section start -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u244677816/domains/stocky.uno/public_html/ecostore/resources/views/front/contactus.blade.php ENDPATH**/ ?>
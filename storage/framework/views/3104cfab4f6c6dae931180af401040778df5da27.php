                ...
                <div class="row row-cols-1 row-cols-md-3 g-4 py-3 addons-manager ">
                    ...
                    <div class="col col-md-6 col-lg-6 col-xl-3">
                        <div class="card h-100 rounded-3">
                            <img src="<?php echo URL(env('ASSETSPATHURL').'addons/' . $addon->image); ?>" alt="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u244677816/domains/stocky.uno/public_html/ecostore/resources/views/admin/apps/index.blade.php ENDPATH**/ ?>
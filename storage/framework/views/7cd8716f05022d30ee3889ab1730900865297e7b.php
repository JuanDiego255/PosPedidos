...
s1.async=true;
s1.src='https://embed.tawk.to/63696944b0d6371309cdd01e/1gh9s6e1k';
s1.charset='UTF-8';
    ...
    <div class="container">
        <div class="row pt-5">
            <div class="col-lg-4 col-md-12 col-sm-4 col-12 mb-md-4 mb-lg-0">
                <a href="<?php echo e(URL::to('/')); ?>" class="footer-logo text-white">
                ...
                <div class="row justify-content-lg-end justify-content-md-between">
                    <div class="col-md-4 col-6 mb-4 mb-md-0 px-0 ">
                        ...
                        <ul class="footer-right-side">
                            <li>
                                <a href="<?php echo e(URL::to('/')); ?>" class="mb-3">
                                    <?php echo e(trans('labels.home')); ?>

                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(URL::to('/aboutus')); ?>" class="mb-3">
                                    <?php echo e(trans('labels.about_us')); ?>

                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(URL::to('/contact')); ?>" class="mb-3">
                            ...
                            <?php if(App\Models\SystemAddons::where('unique_identifier', 'blog')->first() != null &&
                                ...
                                <?php if($blog == 1): ?>
                                    <li>
                                        <a href="<?php echo e(URL::to('/blog-list')); ?>" class="mb-3">
                    ...
                    <div class="col-md-4 col-6 mb-4 mb-md-0 px-0 ">
                        ...
                        <ul class="footer-right-side">
                            <li>
                                <a href="<?php echo e(URL::to('/terms_condition')); ?>" class="mb-3">
                                    <?php echo e(trans('labels.terms')); ?>

                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(URL::to('/privacypolicy')); ?>" class="mb-3">
...
<?php /**PATH /home/u244677816/domains/stocky.uno/public_html/ecostore/resources/views/front/theme/footer.blade.php ENDPATH**/ ?>
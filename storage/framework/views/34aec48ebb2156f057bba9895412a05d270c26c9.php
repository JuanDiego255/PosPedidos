                ...
                <div class="card-body">
                    <div class="card-block d-block d-md-flex align-items-center">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <img class="qr-codeimg" src="https://quickchart.io/qr?text=<?php echo e(URL::to('/')); ?>/<?php echo e(Auth::user()->slug); ?>"
                                title="QR CODE" />
                        </div>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u244677816/domains/stocky.uno/public_html/ecostore/resources/views/admin/otherpages/share.blade.php ENDPATH**/ ?>
                    ...
                    <form action="<?php echo e(URL::to('admin/settings/update_email_config')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="mail_driver" value="<?php echo e(@$settingdata->mail_driver); ?>" placeholder="<?php echo e(trans('labels.mail_driver')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="mail_host" value="<?php echo e(@$settingdata->mail_host); ?>" placeholder="<?php echo e(trans('labels.mail_host')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="mail_port" value="<?php echo e(@$settingdata->mail_port); ?>" placeholder="<?php echo e(trans('labels.mail_port')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="mail_username" value="<?php echo e(@$settingdata->mail_username); ?>" placeholder="<?php echo e(trans('labels.mail_username')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="mail_encryption" value="<?php echo e(@$settingdata->mail_encryption); ?>" placeholder="<?php echo e(trans('labels.mail_encryption')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="mail_fromaddress" value="<?php echo e(@$settingdata->mail_fromaddress); ?>" placeholder="<?php echo e(trans('labels.mail_fromaddress')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="mail_fromname" value="<?php echo e(@$settingdata->mail_fromname); ?>" placeholder="<?php echo e(trans('labels.mail_fromname')); ?>" required>
...
<?php /**PATH /home/u244677816/domains/stocky.uno/public_html/ecostore/resources/views/admin/emailsettings/email_setting.blade.php ENDPATH**/ ?>
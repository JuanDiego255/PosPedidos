                        ...
                        <div class="card-body p-2 p-md-3 pb-0 pb-md-3">
                            <?php if(Auth::user() ): ?>
                                <div class="favorite-icon set-fav1-<?php echo e($itemdata->id); ?>">
                                    ...
                                    <a href="javascript:void(0)" onclick="managefavorite('<?php echo e($storeinfo->id); ?>','<?php echo e($itemdata->id); ?>',0,'<?php echo e(URL::to($storeinfo->slug.'/managefavorite')); ?>')"><i class="fa-solid fa-heart"></i></a>
                                    <?php else: ?>
                                    <a href="javascript:void(0)" onclick="managefavorite('<?php echo e($storeinfo->id); ?>','<?php echo e($itemdata->id); ?>',1,'<?php echo e(URL::to($storeinfo->slug.'/managefavorite')); ?>')"><i class="fa-regular fa-heart"></i></a>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\restropro\resources\views/front/search.blade.php ENDPATH**/ ?>
                ...
                <div class="card-body">
                    <div class="text-section">
                        ...
                        <div class="d-flex align-items-center mt-1">
                            ...
                            <button class="product-cart-icon addcartbtn-<?php echo e($item->id); ?>" type="button"  onclick="showitems('<?php echo e($item->id); ?>','<?php echo e($item->item_name); ?>','<?php echo e($item->item_price); ?>')">
                                <i class="fa-solid fa-cart-shopping"></i>
                            </button>
                            <?php endif; ?>
...
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH /home/u244677816/domains/stocky.uno/public_html/ecostore/resources/views/front/template-1/theme-list.blade.php ENDPATH**/ ?>
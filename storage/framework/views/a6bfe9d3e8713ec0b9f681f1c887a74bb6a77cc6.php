    ...
    <div class="container">
        ...
        <nav class="px-2">
            ...
            <ol class="breadcrumb d-flex text-capitalize">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(URL::to( '/orders/')); ?>" class="text-white"><?php echo e(trans('labels.orders')); ?></a></li>
                    ...
                    <div class="row align-items-center py-3">
                        ...
                        <?php $__currentLoopData = $orderdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $odata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="card my-cart-categories border-bottom rounded-0 dark px-0 py-2">
                                ...
                                <img src="<?php echo e(asset(env('ASSETSPATHURL').'item/' . $odata->item_image)); ?>" class="card-img-top p-0 object-fit-cover border rounded-4" alt="...">
                            ...
                            <div class="card-body cust-info pt-2 pb-0">
                                ...
                                <div class="d-flex align-items-start mb-2">
                                    ...
                                    <address class="px-2">
                                        ...
                                        <b> <?php echo e($summery['building']); ?>, <?php echo e($summery['address']); ?>, <?php echo e($summery['landmark']); ?>, <?php echo e($summery['pincode']); ?> </b>
                    ...
                    <div class="card border-0 px-0 py-2">
                        ...
                        <div class="card-body cust-info pt-2 pb-0">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <?php
                                    $payment_method = helper::payment_method_name($orderdata->payment_type);
                                ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u244677816/domains/stocky.uno/public_html/ecostore/resources/views/front/track-order.blade.php ENDPATH**/ ?>
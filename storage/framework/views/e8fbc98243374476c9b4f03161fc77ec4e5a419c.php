                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item px-0 d-flex justify-content-between">
                                    ...
                                    <span class="text-muted">
                                        ...
                                        <?php
                                            $payment_method = helper::payment_method_name($getorderdata->payment_type);
                                        ?>
                                        ...
                                        <div class="basic-list-group">
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    ...
                                                    <p class="text-muted"><?php echo e($getorderdata->building); ?>, <?php echo e($getorderdata->landmark); ?></p>
                                                </li>
                                                <li class="list-group-item px-0 d-flex justify-content-between">
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u244677816/domains/stocky.uno/public_html/ecostore/resources/views/admin/orders/invoice.blade.php ENDPATH**/ ?>
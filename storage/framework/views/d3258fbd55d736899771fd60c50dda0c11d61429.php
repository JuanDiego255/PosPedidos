        ...
        <nav class="px-2">
            ...
            <ol class="breadcrumb d-flex text-capitalize">
                ...
                <li class="breadcrumb-item">
                    ...
                    <a href="<?php echo e(URL::to('/')); ?>" class="text-white"><?php echo e(trans('labels.home')); ?></a>
...
<?php echo $__env->make('front.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u244677816/domains/stocky.uno/public_html/ecostore/resources/views/front/about.blade.php ENDPATH**/ ?>
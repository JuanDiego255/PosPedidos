...
<script src="<?php echo e(url(env('ASSETSPATHURL') . 'admin-assets/js/pos_cartview.js')); ?>" type="text/javascript"></script><?php /**PATH C:\laragon\www\restropro\resources\views/admin/pos/cartview.blade.php ENDPATH**/ ?>
    ...
    <div class="container">
        <div class="row">
                            ...
                            <form action="#" method="get">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" class="form-control input-h" name="address" id="address" placeholder="Dirección" >
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <label for="validationDefault" class="form-label"><?php echo e(trans('labels.landmark')); ?><span class="text-danger"> </span></label>
                                        <input type="text" class="form-control input-h"   name="landmark"  id="landmark" placeholder="Punto de referencia" >
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <label for="validationDefault" class="form-label"><?php echo e(trans('labels.building')); ?></label>
                                        <input type="text" class="form-control input-h" name="building" id="building" placeholder="N° Casa" >
                                    </div>
                                    <!--<div class="col-md-6 mb-4">
                                        <label  class="form-label"><?php echo e(trans('labels.pincode')); ?></label>
                                        <input type="number" class="form-control input-h" placeholder="Codigo postal" name="postal_code" id="postal_code" >
                                    </div>!-->
                                </div>
                            </form>
                        </div>
                            ...
                            <form action="#" method="get">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" class="form-control input-h" placeholder="Nombre"  name="customer_name" id="customer_name" value="<?php echo e(@Auth::user() && @Auth::user()->type == 3 ? @Auth::user()->name : ''); ?>" >
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <label for="validationDefault" class="form-label"><?php echo e(trans('labels.mobile')); ?><span class="text-danger"> * </span></label>
                                        <input type="number" class="form-control input-h" placeholder="Telefono" name="customer_mobile" id="customer_mobile" value="<?php echo e(@Auth::user() && @Auth::user()->type == 3 ? @Auth::user()->mobile : ''); ?>" >
                                    </div>
                                    <!--<div class="col-md-6 mb-4">
                                        <label class="form-label"><?php echo e(trans('labels.email')); ?><span class="text-danger">*  </span></label>
                                        <input type="email" class="form-control input-h" placeholder="Correo"  name="customer_email" id="customer_email" value="<?php echo e(@Auth::user() && @Auth::user()->type == 3 ? @Auth::user()->email : ''); ?>" >
                                    </div>!-->
                                    <div class="col-md-6 mb-4">
                                        <label class="form-label"><?php echo e(trans('labels.note')); ?><span class="text-danger">  </span></label>
                                        <textarea id="notes" name="notes" class="form-control input-h" rows="5" aria-label="With textarea" placeholder="Nota" value=""></textarea> 
                                    </div>
            ...
            <div class="col-md-12 col-lg-4">
                            ...
                            <div class="row border shadow rounded-4 py-3 mb-4">
                                <div class="card border-0 select-delivery" >
                                    <div class="card-body row justify-content-between align-items-center">
                                        <div class="d-flex align-items-start col-md-6 col-lg-12 col-xl-7 px-0">
                                            <div>
                                                <p class="title px-2 mb-2"><i class="fa-solid fa-receipt"></i><span class="px-2" id="promocode_code"><?php if(Session::has('offer_amount')): ?> <?php echo e(Session::get('offer_code')); ?> aplicado <?php else: ?> <?php echo e(trans('labels.apply_coupon')); ?> <?php endif; ?> </span></p>
                                                <p class="apply-coupon-subtitle" id="promocode_desc"><?php if(!Session::has('offer_amount')): ?> <?php echo e(trans('labels.save_offer')); ?><?php endif; ?></p>
                                            </div>
                                        </div>
                                        <input type="hidden" id="removecouponurl" value="<?php echo e(URL::to('/cart/removepromocode')); ?>"/>
                                ...
                                <form>
                                    ...
                                    <div class="col-12 select-payment-list-items">
                                        <label class="form-check-label d-flex  justify-content-between align-items-center" for="<?php echo e($payment->payment_name); ?>">
                                            <div class="d-flex align-items-center">
                                                <input class="form-check-input m-0" type="radio" id="<?php echo e($payment->payment_name); ?>"  name="payment" data-payment_type="<?php echo e(strtolower($payment->id)); ?>"  data-currency="<?php echo e($payment->currency); ?>"  <?php if(!$key): ?> <?php echo 'checked'; ?> <?php endif; ?>  value="<?php echo e($payment->public_key); ?>">
                                                <!--<input type="hidden" id="payment_method_id_<?php echo e($payment->id); ?>"  name="payment_method_id" data-payment_type_id="<?php echo e(strtolower($payment->id)); ?>">-->
                ...
                <button target="_blank" class="btn-primary text-center w-100"  onclick="Order()"><?php echo e(trans('labels.place_order')); ?></button>
            </div>
        </div>
    </div>
</section>
        ...
        if (result.isConfirmed) {
                ...
                success: function(response) {
                    ...
                    let coupons = "<?php echo e($coupons->count()); ?>";
                        html = ' <a class="btn-primary d-inline-bloc fs-7 mt-3 mobile-viwe-btn mt-md-0 mt-lg-3 mt-xl-0 mt-xxl-0" href="#" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">'+coupons+'  Oferta(S)</a>';
                        var grand_total =   (parseFloat($('#grand_total').val()) + parseFloat($('#discount_amount').val()));
                       
                        $('#discount_1').remove();
                        $('#promocode_button').html(html);
                        $('#promocode_code').html("Aplicar cupon");
                        $('#promocode_desc').show();
                        $('#discount_amount').val('');
                        $('#couponcode').val('');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/davcromc/tienda1.sistemaslvam.com/resources/views/front/checkout.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-sm-6">
                                                    <label class="form-label">Color segundaria</label>
                                                    <div class="row g-2">
                                                        <div class="col-auto">
                                                            <div id="bg-selector" tooltip="Custom" class="position-relative">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u244677816/domains/stocky.uno/public_html/ecostore/resources/views/admin/otherpages/settings.blade.php ENDPATH**/ ?>
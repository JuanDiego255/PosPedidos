                    ...
                    <div class="col-md-6 col-12">
                        <div class="banner-content me-xl-5 me-lg-3 me-md-2">
                            ...
                            <div class="input-group mb-lg-4 mb-3">
                                <a href="<?php echo e(URL::to('/admin')); ?>" class="btn btn-secondary rounded h-45"
                                    target="_blank"><span class="m-0  fs-6"><?php echo e(trans('landing.get_started')); ?></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-12 mb-4 mb-md-0">
                                <div class="card h-100 border-0 rounded-0 pb-xl-5">
                                    ...
                                    <div class="card-footer border-0 bg-transparent">
                                        <a href="<?php echo e(URL::to('/admin')); ?>" class="border-bottom ms-4 fw-500 ms-lg-0 ms-xl-4"
                ...
                <div class="container">
                    ...
                    <div class="templates-owl owl-carousel owl-theme text-white">
                        <div class="item h-100 temp-active">
                            <img src="<?php echo e(url(env('ASSETSPATHURL') . 'landing/images/png/01.webp')); ?>" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100">
                            <img src="<?php echo e(url(env('ASSETSPATHURL') . 'landing/images/png/02.webp')); ?>" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100">
                            <img src="<?php echo e(url(env('ASSETSPATHURL') . 'landing/images/png/03.webp')); ?>" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100">
                            <img src="<?php echo e(url(env('ASSETSPATHURL') . 'landing/images/png/04.webp')); ?>" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100 temp-active">
                            <img src="<?php echo e(url(env('ASSETSPATHURL') . 'landing/images/png/05.webp')); ?>" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100">
                            <img src="<?php echo e(url(env('ASSETSPATHURL') . 'landing/images/png/06.webp')); ?>" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100">
                            <img src="<?php echo e(url(env('ASSETSPATHURL') . 'landing/images/png/07.webp')); ?>" alt=""
                                class="object-fit-cover h-100">
                        </div>
                        <div class="item h-100">
                            <img src="<?php echo e(url(env('ASSETSPATHURL') . 'landing/images/png/08.webp')); ?>" alt=""
                                class="object-fit-cover h-100">
                        </div>
                    </div>
                    <!-- theme-preview-content -->
                        ...
                        <form class="row" action="<?php echo e(URL::to('inquiry')); ?>" method="POST">
                            ...
                            <div class="col-md-6 mb-4 mb-lg-5">
                                <label for="first_name"
                                    class="form-label m-0 fw-semibold fs-7"><?php echo e(trans('landing.first_name')); ?> <span
                            ...
                            <div class="col-md-6 mb-4 mb-lg-5">
                                <label for="last_name"
                                    class="form-label m-0 fw-semibold fs-7"><?php echo e(trans('landing.last_name')); ?> <span
                                        class="text-danger">*</span></label>
                                <input type="text"
                                    class="form-control border-0 border-bottom rounded-0 p-0 pb-1 px-0 fs-7"
                            ...
                            <div class="col-md-6 mb-4 mb-lg-5">
                                <label for="emaill"
                                    class="form-label m-0 fw-semibold fs-7"><?php echo e(trans('landing.email')); ?> <span
                                        class="text-danger">*</span></label>
                                <input type="email"
                                    class="form-control border-0 border-bottom rounded-0 p-0 pb-1 px-0 fs-7"
                            ...
                            <div class="col-md-6 mb-4 mb-lg-5">
                                <label for="phone"
                                    class="form-label m-0 fw-semibold fs-7"><?php echo e(trans('landing.mobile')); ?> <span
                                        class="text-danger">*</span></label>
                                <input type="number"
                                    class="form-control border-0 border-bottom rounded-0 p-0 pb-1 px-0 fs-7"
                            ...
                            <div class="col-md-12 mb-lg-5 mb-md-3 mb-4">
                                <label for="Message"
                                    class="form-label m-0 fw-semibold fs-7"><?php echo e(trans('landing.message')); ?> <span
                                        class="text-danger">*</span></label>
...
<?php echo $__env->make('landing.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lotquispe/mailpro.rimberio.site/resources/views/landing/index.blade.php ENDPATH**/ ?>
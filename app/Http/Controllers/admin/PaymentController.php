...
class PaymentController extends Controller
{
    ...
    public function update(Request $request)
    {
        $data = Payment::find($request->transaction_type);
            ...
            // new code added by hadi for updating the payment method name:begins
            if(isset($request->payment_method_name)){
                $data->payment_name = $request->payment_method_name;
            }
            // new code added by hadi for updating the payment method name:ends

...
class POSController extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            if ($request->ajax()) {
                ...
                return view('admin.pos.index', compact('getcategory', 'getitem', 'cat_id', 'cartitems', 'getcustomerslist', 'ordersdetails', 'clients'));
            }
        } catch (\Throwable $th) {
    ...
    public function addtocart(Request $request)
    {
        ...
        try {
            ...
            $ordersdetails = array();
            $clients = Client::orderBy('id', 'DESC')->get();
            return view('admin.pos.cartview', compact('cartitems', 'getcustomerslist', 'ordersdetails', 'clients'));
        } catch (\Exception $e) {
    ...
    public function createorder(Request $request)
    {
        ...
        try {
            ...
            if ($data->count() > 0) {
                ...
                $order->delivery_charge = $request->delivery_price;
                $order->status = '2';
                ...
                // Client Data by Madi...
                $client_data['name'] = $request->client_name;
                $client_data['email'] = $request->client_email;
                $client_data['contact'] = $request->client_contact;
                $client_data['address'] = $request->client_address;
                $client_data['state'] = $request->client_state;
                $client_detail = json_encode($client_data);
                ...
                foreach ($data as $value) {
                    ...
                    $OrderPro->client_detail = $client_detail;
                    $OrderPro->save();
                }
                ...
                $client_detail = Client::where('id', $getorderdata->client_id)->first();
                ...
                return view('admin.pos.cartview', compact('cartitems', 'getcustomerslist', 'customerinfo', 'ordersdetails', 'getorderdata', 'client_detail'));
            } else {

    ...
    <div class="container">
        ...
        <nav class="px-2">
            ...
            <ol class="breadcrumb d-flex text-capitalize">
                ...
                <li class="breadcrumb-item"><a href="{{ URL::to( '/orders/') }}" class="text-white">{{ trans('labels.orders') }}</a></li>
                    ...
                    <div class="row align-items-center py-3">
                        ...
                        @foreach ($orderdetails as $odata)
                            ...
                            <div class="card my-cart-categories border-bottom rounded-0 dark px-0 py-2">
                                ...
                                <img src="{{ asset(env('ASSETSPATHURL').'item/' . $odata->item_image) }}" class="card-img-top p-0 object-fit-cover border rounded-4" alt="...">

               ...
               <div class="container">
                    <div class="theme-1banner-text">
                         ...
                         <button id="storeStatusBtn" class="btn btn-primary floating-btn" data-bs-toggle="modal" data-bs-target="#infomodal" style="background-color: white; color: black;">
                            <i class="fas fa-dot-circle {{ helper::getStoreStatus($storeinfo->id) == 'Abierto' ? 'open' : 'closed' }}" aria-hidden="true"></i>
                    
                            <span>{{ helper::getStoreStatus($storeinfo->id) }}</span> 
     ...
     <section class="theme-1-margin-top">
          <div class="container">
               ...
               <ul class="navgation_lower overflow-auto theme-1-category-card py-3 m-0 flex-lg-wrap">
                    ...
                    <li class="{{ $key == 0 ? 'active1' : '' }} mb-4 mx-lg-0 mx-4 theme-1category-width" id="specs-{{$category->id}}">
               ...
               <div class="row blogs-card">
                    <div class="row align-items-center">
                         ...
                         <div class="col-4 d-flex justify-content-end align-items-center">
                              <a href="{{URL::to('/blog-list')}}" class="border text-dark p-1 rounded-3">

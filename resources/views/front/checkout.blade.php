    ...
    <div class="container">
        <nav class="mx-2">
            ...
            <ol class="breadcrumb d-flex text-capitalize">
                <li class="breadcrumb-item"><a href="{{URL::to('/')}}" class="text-white">  {{trans('labels.home')}}</a></li>
                            ...
                            <form action="#" method="get">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" class="form-control input-h" placeholder="Nombre"  name="customer_name" id="customer_name" value="{{ @Auth::user() && @Auth::user()->type == 3 ? @Auth::user()->name : '' }}" >
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <label for="validationDefault" class="form-label">{{ trans('labels.mobile') }}<span class="text-danger"> * </span></label>
                                        <input type="number" class="form-control input-h" placeholder="Telefono" name="customer_mobile" id="customer_mobile" value="{{ @Auth::user() && @Auth::user()->type == 3 ? @Auth::user()->mobile : '' }}" >
                                    </div>
                                    <!--<div class="col-md-6 mb-4">
                                        <label class="form-label">{{ trans('labels.email') }}<span class="text-danger">*  </span></label>
                                        <input type="email" class="form-control input-h" placeholder="Correo"  name="customer_email" id="customer_email" value="{{ @Auth::user() && @Auth::user()->type == 3 ? @Auth::user()->email : '' }}" >
                                    </div>!-->
                                    <div class="col-md-6 mb-4">
                            ...
                            <div class="row border shadow rounded-4 py-3 mb-4">
                                <div class="card border-0 select-delivery" >
                                    <div class="card-body row justify-content-between align-items-center">
                                        <div class="d-flex align-items-start col-md-6 col-lg-12 col-xl-7 px-0">
                                            <div>
                                                <p class="title px-2 mb-2"><i class="fa-solid fa-receipt"></i><span class="px-2" id="promocode_code">@if (Session::has('offer_amount')) {{ Session::get('offer_code') }} aplicado @else {{ trans('labels.apply_coupon') }} @endif </span></p>
                                                <p class="apply-coupon-subtitle" id="promocode_desc">@if (!Session::has('offer_amount')) {{ trans('labels.save_offer') }}@endif</p>
                                            </div>
                                        </div>
                                        <input type="hidden" id="removecouponurl" value="{{ URL::to('/cart/removepromocode') }}"/>
                                ...
                                <form>
                                    ...
                                    <div class="col-12 select-payment-list-items">
                                        <label class="form-check-label d-flex  justify-content-between align-items-center" for="{{ $payment->payment_name }}">
                                            <div class="d-flex align-items-center">
                                                <input class="form-check-input m-0" type="radio" id="{{ $payment->payment_name }}"  name="payment" data-payment_type="{{strtolower($payment->id)}}"  data-currency="{{ $payment->currency }}"  @if (!$key) {!! 'checked' !!} @endif  value="{{ $payment->public_key }}">
                                                <!--<input type="hidden" id="payment_method_id_{{ $payment->id }}"  name="payment_method_id" data-payment_type_id="{{strtolower($payment->id)}}">-->

    ...
    <div class="container">
        <nav class="px-2">
            ...
            <ol class="breadcrumb d-flex text-capitalize">
                <li class="breadcrumb-item"><a href="{{URL::to('/')}}" class="text-white">{{ trans('home') }}</a></li>
                                ...
                                <div class="card h-100 position-relative">
                                    ...
                                    <div class="card-body p-2 p-md-3 pb-0 pb-md-3">
                                        ...
                                        <div class="favorite-icon set-fav1-{{ $itemdata->id }}">
                                            <a href="javascript:void(0)" onclick="removefavorite('{{$storeinfo->id}}','{{ $itemdata->id }}',0,'{{ URL::to('/managefavorite') }}')"><i class="fa-solid fa-heart"></i></a>
                                        </div>
                                        @endif
                                    ...
                                    <div class="card-footer bg-transparent border-0 p-2 p-md-3 pt-0 pt-md-3">
                                        <div class="row justify-content-between align-items-center gx-0">
                                            ...
                                            <div class="col-3 col-md-8 d-flex justify-content-end mb-2 mb-md-0">
                                                ...
                                                <button class="btn-primary product-cart-icon addcartbtn-{{$itemdata->id}}" type="button" onclick="showitems('{{ $itemdata->id }}','{{$itemdata->item_name}}','{{$itemdata->item_price}}')">
                                                    <i class="fa-solid fa-cart-shopping"></i>
                                                </button>
                                                @endif
                                            </div>

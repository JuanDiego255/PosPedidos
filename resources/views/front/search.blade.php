                        ...
                        <div class="card-body p-2 p-md-3 pb-0 pb-md-3">
                            @if(Auth::user() )
                                <div class="favorite-icon set-fav1-{{ $itemdata->id }}">
                                    ...
                                    <a href="javascript:void(0)" onclick="managefavorite('{{$storeinfo->id}}','{{ $itemdata->id }}',0,'{{ URL::to('/managefavorite') }}')"><i class="fa-solid fa-heart"></i></a>
                                    @else
                                    <a href="javascript:void(0)" onclick="managefavorite('{{$storeinfo->id}}','{{ $itemdata->id }}',1,'{{ URL::to('/managefavorite') }}')"><i class="fa-regular fa-heart"></i></a>
                                    @endif
                                </div>
                            @endif

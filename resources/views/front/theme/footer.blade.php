    ...
    <div class="container">
        <div class="row pt-5">
            <div class="col-lg-4 col-md-12 col-sm-4 col-12 mb-md-4 mb-lg-0">
                <a href="{{ URL::to('/') }}" class="footer-logo text-white">
                ...
                <div class="row justify-content-lg-end justify-content-md-between">
                    <div class="col-md-4 col-6 mb-4 mb-md-0 px-0 ">
                        ...
                        <ul class="footer-right-side">
                            <li>
                                <a href="{{ URL::to('/') }}" class="mb-3">
                                    {{ trans('labels.home') }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ URL::to('/aboutus') }}" class="mb-3">
                                    {{ trans('labels.about_us') }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ URL::to('/contact') }}" class="mb-3">
                            ...
                            @if (App\Models\SystemAddons::where('unique_identifier', 'blog')->first() != null &&
                                ...
                                @if($blog == 1)
                                    <li>
                                        <a href="{{ URL::to('/blog-list') }}" class="mb-3">
                                            {{ trans('labels.blogs') }}
                                        </a>
                                    </li>
                                @endif
                    ...
                    <div class="col-md-4 col-6 mb-4 mb-md-0 px-0 ">
                        ...
                        <ul class="footer-right-side">
                            <li>
                                <a href="{{ URL::to('/terms_condition') }}" class="mb-3">
                                    {{ trans('labels.terms') }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ URL::to('/privacypolicy') }}" class="mb-3">

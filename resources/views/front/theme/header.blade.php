            ...
            <div class="modal-body">
                <div class="d-flex justify-content-between align-items-center">
                 ...
                 <div class="ml-lg-0 text-center text-md-end">
                    @if(helper::appdata($storeinfo->id)->contact)
                        <a href="tel:{{ helper::appdata($storeinfo->id)->contact }}" target="_blank" style="font-size: 15px; !important">
                            <i class="fa fa-phone"></i> {{ ' '.helper::appdata($storeinfo->id)->contact }}
                        </a>
                    @endif   &nbsp;&nbsp;&nbsp;

                    <a href="https://www.google.com/maps/place/323/{{ helper::appdata($storeinfo->id)->address }}" target="_blank" style="font-size: 15px; !important">
                        <i class="fa-light fa-location-dot"></i> {{ ' '.helper::appdata($storeinfo->id)->address }}
                    </a>
                    </div>
                 </div>
                ...
                <div class="d-block d-md-flex align-items-center justify-content-center pb-3">
                    ...
                    <div class="ml-lg-0 text-center text-md-end">
                        ...
                        <a class="btn btn-outline m-1 border-0" href="{{ helper::appdata($storeinfo->id)->linkedin_link }}"
                        ...
                        @if($delivery_types)
                            @foreach ($delivery_types as $key => $delivery_type)
                                @if($delivery_type == 1)
                                    <div class="mb-1 payment-check d-flex cp">
                                        <label class="px-3 py-2 option-label cp text-start d-flex align-items-center" style="border: 1px solid rgba(0,0,0,0.3); border-radius: 50px;">
                                            <img src="{{ url(env('ASSETSPATHURL') . '/front/images/order_delivery.png') }}" alt="delivery" style="width: 25px !important;">
                                            <span class="px-2">{{ trans('labels.delivery') }}</span>
                                        </label>
                                    </div>
                                    <br>&nbsp;
                                @endif
                                @if($delivery_type == 2)
                                    <div class="mb-1 payment-check d-flex cp">
                                        <label class="px-3 py-2 option-label cp text-start d-flex align-items-center" style="border: 1px solid rgba(0,0,0,0.3); border-radius: 50px;">
                                            <img src="{{ url(env('ASSETSPATHURL') . '/front/images/pickup.png') }}" alt="delivery" style="width: 25px !important;">
                                ...
                                @if($delivery_type == 3)
                                    <div class="mb-1 payment-check d-flex cp">
                                        <label class="px-3 py-2 option-label cp text-start d-flex align-items-center" style="border: 1px solid rgba(0,0,0,0.3); border-radius: 50px;">
                                            <img src="{{ url(env('ASSETSPATHURL') . '/front/images/dining_table.png') }}" alt="delivery" style="width: 25px !important;">
                                            <span class="px-2">{{ trans('labels.table') }}</span>
                                        </label>
                                    </div>
                                @endif
                            @endforeach
...
<div class="contSearch has-transition js-toggle-cart" style="background-color: var(--bs-primary);" id="floating_cart_btn">
    <div class="d-none d-xl-block align-self-stretch mr-0 has-transition h-100"
        ...
        <div class="nav-cart-box dropdown h-100" id="cart_items" style="width: max-content;">
            <a href="javascript:void(0)" class="d-flex align-items-center text-dark h-100 justify-content-center" data-toggle="dropdown" data-display="static" title="{{ trans('labels.my_cart') }}">
                    ...
                    <span class="cart-counting mx-2" id="cartcount2">{{ helper::getcartcount($storeinfo->id, @Auth::user()->id) }}</span> 
            </a>
            <p class="text-white">{{ trans('labels.item') }}</p>
        </div>
    </div>
</div>
...
<aside class="floating_cart js-cart">
  <div class="floating_cart__header">
    <h1 class="floating_cart__title d-flex justify-content-center align-items-center">
        ...
        <span class="cart-counting mx-2" id="cartcount3">{{ helper::getcartcount($storeinfo->id, @Auth::user()->id) }}</span> 
        <span style="font-size:0.92rem">{{ trans('labels.item') }}</span>
    </h1>

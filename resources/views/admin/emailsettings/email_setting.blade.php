                    ...
                    <form action="{{ URL::to('admin/settings/update_email_config') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="mail_driver" value="{{ @$settingdata->mail_driver }}" placeholder="{{ trans('labels.mail_driver') }}" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="mail_host" value="{{ @$settingdata->mail_host }}" placeholder="{{ trans('labels.mail_host') }}" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="mail_port" value="{{ @$settingdata->mail_port }}" placeholder="{{ trans('labels.mail_port') }}" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="mail_username" value="{{ @$settingdata->mail_username }}" placeholder="{{ trans('labels.mail_username') }}" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="mail_encryption" value="{{ @$settingdata->mail_encryption }}" placeholder="{{ trans('labels.mail_encryption') }}" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="mail_fromaddress" value="{{ @$settingdata->mail_fromaddress }}" placeholder="{{ trans('labels.mail_fromaddress') }}" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="mail_fromname" value="{{ @$settingdata->mail_fromname }}" placeholder="{{ trans('labels.mail_fromname') }}" required>

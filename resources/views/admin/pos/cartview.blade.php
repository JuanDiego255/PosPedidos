                        ...
                        <div class="pro-itmes p-3 pb-0">
                            ...
                            <div class="card mb-3 border rounded-4 shadow-sm posproductimg">
                                <div class="card-body d-flex align-items-center p-0">
                                    <img src="{{ asset(env('ASSETSPATHURL').'item/' . $cart->item_image) }}" alt="">
                                    <div class="px-2">
        ...
        <div class="modal-content">
                            ...
                            <label class="bg-light">
                                ...
                                <div class="card h-100 rounded-3">
                                    <div class="card-body p-2 w-100 d-flex justify-content-center">
                                        <div>
                                            <img src="{{url(env('ASSETSPATHURL').'images/llevar.png')}}" alt="" class="">
                                        </div>
                                    </div>
                                </div>
                            </label>
                        ...
                        <div class="w-100 rounded-4">
                            <label class="bg-light">
                                ...
                                <div class="card h-100 rounded-3">
                                    <div class="card-body p-2 w-100 d-flex justify-content-center">
                                        <div>
                                            <img src="{{url(env('ASSETSPATHURL').'images/entrega.png')}}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </label>
            ...
            <div class="modal-footer">
                <div class="gap-1 d-flex justify-content-md-end sm-w-100">
                    ...
                    <a href="#" class="btn btn-success btn-succes m-1 sm-w-100" @if(count($cartitems)> 0) onclick="placeorder()" @endif >Enviar</a>
                </div>
            </div>
        </div>
    </div>

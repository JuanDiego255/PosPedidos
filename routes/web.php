...
Route::middleware(['auth'])->group(function () {
    // Rutas para la configuración de correo electrónico
    Route::post('/admin/email-settings', [EmailSettingsController::class, 'emailSettings'])->name('admin.email.settings');
    Route::post('/admin/test-mail', [EmailSettingsController::class, 'testMail'])->name('admin.test.mail');
});
...
// Update made by Hadi for redirecting to store page.
